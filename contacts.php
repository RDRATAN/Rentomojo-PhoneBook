        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="process_form.php">
          ...
          <fieldset>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label class="col-lg-4 control-label" for="dob"><span class="required">*</span>Date of Birth:</label>
              <div class="col-lg-5">
                <input type="Date" value="<?php echo $results[0]["dob"] ?>" placeholder="Date of Birth" id="dob" class="form-control" name="dob"><span id="dob_error" class="error"></span>
              </div>
            </div>
