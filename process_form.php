...
if ($mode == "add_new" ) {
  ...
  if (!$error) {
    $sql = "INSERT INTO `tbl_contacts` (`first_name`, `middle_name`, `last_name`, `dob`, `contact_no1`, `contact_no2`, `email_address`, `profile_pic`) VALUES "
            . "( :fname, :mname, :lname, :dob, :contact1, :contact2, :email, :pic)";
  ...
  if (!$error) {
    $sql = "UPDATE `tbl_contacts` SET `first_name` = :fname, `middle_name` = :mname, `last_name` = :lname, `dob` = :dob, `contact_no1` = :contact1, `contact_no2` = :contact2, `email_address` = :email, `profile_pic` = :pic  "
